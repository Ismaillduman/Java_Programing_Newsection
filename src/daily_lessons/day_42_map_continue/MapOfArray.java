...
public class MapOfArray {
    public static void main(String[] args) {
        ...
        arrayOfMap[0].replace("salary",(Integer)arrayOfMap[0].get("salary")+10000);
        System.out.println(arrayOfMap[0].get("salary"));
        arrayOfMap[0].replace("name","Darly");
        System.out.println(arrayOfMap[0].get("name"));
